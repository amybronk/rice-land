...
alias cleanup 'sudo pacman -Rns (pacman -Qdtq)'     # Schone Arch manier om orphans te cleanen
...
alias grubup 'sudo grub-mkconfig -o /boot/grub/grub.cfg' # Fix voor Arch GRUB
...
alias upd 'paru -Syu'                              # Fix voor Arch update (of yay -Syu)
