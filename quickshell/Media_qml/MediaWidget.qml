...
PopupWindow {
        ...
        onHoveredChanged: {
            if (hovered) {
                ...
                if (closeAnim.running) {
                    ...
                    openAnim.from = -mediawindow.height
                    openAnim.start()
                }
            } else {
                closeTimer.start()
    ...
    Item {
        ...
        NumberAnimation {
            ...
            property: "y"
            from: 0
            to: -mediawindow.height
            duration: Style.animateTimePopup
            easing.type: Easing.InQuart
            running: false
            onStopped: if (slideDouwn.y <= -mediawindow.height + 1) musiccontrol.active = false
        }
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            scale: playerHover.hovered ? Style.shrinkAnimateS : 1.0
